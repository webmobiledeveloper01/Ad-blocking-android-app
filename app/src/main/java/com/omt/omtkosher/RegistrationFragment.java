...
public class RegistrationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MaterialButton btn = v.findViewById(R.id.finish_btn);

        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(requireActivity(),MainScreenActivity.class);
                startActivity(i);
            }
        });
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ((EnrollmentActivity) requireActivity()).binding.included4.tv.setBackgroundResource(R.drawable.circle);
        ...
        ((EnrollmentActivity) requireActivity()).binding.space3.setBackgroundColor(Color.parseColor("#3891f5"));
